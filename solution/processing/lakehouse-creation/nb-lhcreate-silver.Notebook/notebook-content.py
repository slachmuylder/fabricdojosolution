...
silver_lh_name = variables.lh_silver_name
...
for schema_name in SILVER_LH_SCHEMAS_TO_CREATE: 
    ...
    # create a dynamic Spark SQL script, reading from the Variable Library variables, and the SILVER_LH_SCHEMAS_TO_CREATE metadata
